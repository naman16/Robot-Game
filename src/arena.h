...
class Arena {
 public:
  ...
  void AddRobot();
  void AddBase(EntityType type, int quantity);
  void AddObstacle(EntityType type, int quantity);
  ...
  **/
  ...
  /**
   * @brief Count the total number of bases in the arena.
   *
   */
  int TotalNumberOfBases();
